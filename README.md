#generator-springular

[Extending the generator-cg-angular](https://github.com/cgross/generator-cg-angular)

>Yeoman Generator for Enterprise Angular and Spring boot Projects extending Polymer
...
Next, install this generator:
    ...
    npm install -g generator-springular
...
Now that the project is created, you have 3 simple Grunt commands available:
    ...
    grunt build   #Places a fully optimized (minified, concatenated, and more) in /static
...
Running a generator:
    ...
    yo springular:directive my-awesome-directive
    yo springular:partial my-partial
    yo springular:service my-service
    yo springular:filter my-filter
    yo springular:module my-module
    yo springular:modal my-modal
